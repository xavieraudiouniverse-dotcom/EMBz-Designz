        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            <SheetFooter className="px-5 py-4 border-t border-border block">
              ...
              <Button className="w-full rounded-md bg-neon text-[#0C0B09] hover:bg-neon/90 shadow-[0_0_22px_rgba(244,212,0,0.3)] font-mono uppercase tracking-widest" onClick={goCheckout} data-testid="cart-checkout-button">
                Checkout
              </Button>
            </SheetFooter>
          </>
