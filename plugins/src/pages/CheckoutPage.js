      ...
      <div className="grid lg:grid-cols-[1fr_380px] gap-10">
        ...
        <div className="lg:sticky lg:top-24 lg:self-start">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <Button className="mt-5 w-full rounded-md bg-neon text-[#0C0B09] hover:bg-neon/90 shadow-[0_0_22px_rgba(244,212,0,0.3)] font-mono uppercase tracking-widest" size="lg" onClick={placeOrder} disabled={placing || quoting} data-testid="checkout-place-order-button">
