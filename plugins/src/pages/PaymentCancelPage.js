    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full rounded-2xl border border-border bg-card p-8 text-center">
        ...
        <div className="mt-6 flex flex-col gap-2">
          <Button asChild className="rounded-md bg-neon text-[#0C0B09] hover:bg-neon/90 shadow-[0_0_22px_rgba(244,212,0,0.3)] font-mono uppercase tracking-widest"><Link to="/checkout">Return to checkout</Link></Button>
