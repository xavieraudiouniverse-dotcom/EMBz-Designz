          ...
          {(state === "timeout" || state === "error") && (
            <>
              ...
              <div className="mt-6 flex flex-col gap-2">
                <Button asChild className="rounded-md bg-neon text-[#0C0B09] hover:bg-neon/90 shadow-[0_0_22px_rgba(244,212,0,0.3)] font-mono uppercase tracking-widest"><Link to="/track">Track my order</Link></Button>
