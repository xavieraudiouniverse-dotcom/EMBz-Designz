    ...
    <div>
      ...
      <section className="relative overflow-hidden neon-night vignette">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-36 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-[#04050A]/70 px-3.5 py-1.5 label-caps">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              <Button asChild size="lg" className="rounded-md bg-neon text-[#04050A] hover:bg-neon/90 shadow-[0_0_22px_rgba(0,229,255,0.22)] font-mono uppercase tracking-widest" data-testid="primary-cta-button">
        ...
        {/* Ticker */}
        <div className="relative border-y border-border bg-[#04050A]/80 overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-dashed border-border bg-card p-10 text-center">
            ...
            <Button asChild className="mt-5 rounded-md bg-neon text-[#07080B] hover:bg-neon/90 shadow-[0_0_22px_rgba(0,229,255,0.28)] font-mono uppercase tracking-widest"><Link to="/admin">Open studio</Link></Button>
          </div>
        )}
      </section>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={s.n} className="rounded-xl border border-border bg-[#07080B]/60 p-6">
          ...
          <div className="mt-12 text-center">
            ...
            <Button asChild size="lg" className="mt-8 rounded-md bg-neon text-[#07080B] hover:bg-neon/90 shadow-[0_0_22px_rgba(0,229,255,0.28)] font-mono uppercase tracking-widest">
